...
class AutfLoginWidget extends StatefulWidget {
  AutfLoginWidget({Key? key}) : super(key: key);

  @override
  State<AutfLoginWidget> createState() => _AutfWidgetState();
}

final iconColor = const Color(0xFF2787F5);

class _AutfWidgetState extends State<AutfLoginWidget> {
  @override
